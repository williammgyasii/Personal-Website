...
export const lawprepAi: ProjectDetail = {
  ...
  slug: "lawprep-ai",
  name: "LawPrep AI",
  subline: "Serious LSAT Prep. Accessible Pricing. AI That Knows Your Materials.",
  category: "fullstack",
  status: "in-progress",
  technologies: ["Next.js", "React", "TypeScript", "PostgreSQL", "Drizzle ORM", "OpenAI", "Stripe", "Tailwind CSS", "Vercel"],
  keyFeatures: [
    { title: "Official PrepTest Practice", description: "10,000+ questions from 80+ official PrepTests—Logical Reasoning, Reading Comp, and Analytical Reasoning with timed sessions that mirror test day pressure." },
    { title: "AI Study Assistant", description: "Upload your notes, textbooks, or URLs. AI generates summaries, flashcards, quizzes, and chat explanations from your content—not generic prep material." },
    { title: "LSAT Writing Simulator", description: "Official timing: 15 minutes prewriting, 35 minutes essay. The section most prep courses ignore, built in." },
    { title: "Freemium SaaS Tiers", description: "Starter (free), Pro ($19/mo), Premium ($39/mo)—Stripe-backed gating that converts because limits feel fair, not punitive." },
  ],
  description: "LawPrep AI is the LSAT prep platform law school applicants actually need: 10,000+ official PrepTest questions across every section, an AI study assistant that learns from your uploaded materials, and a writing simulator with real LSAT timing. Freemium tiers (Starter free, Pro $19/mo, Premium $39/mo) convert because the free product delivers genuine value—not a teaser. Built on Next.js with serverless PostgreSQL, Stripe billing, and production AI pipelines.",
  problemStatement: {
  ...
  outcomes: "LawPrep AI makes serious test prep accessible at every budget—official questions, adaptive AI tools, and freemium pricing that respects students' wallets. A full-stack SaaS proving edtech can compete with $3,000 courses on product quality alone.",

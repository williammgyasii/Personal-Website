...
export const festura: ProjectDetail = {
  ...
  slug: "festura",
  name: "Festura",
  subline: "Culture-First Wedding & Vendor Marketplace",
  category: "fullstack",
  status: "in-progress",
  technologies: ["Next.js", "React", "TypeScript", "PostgreSQL", "Vercel", "Tailwind CSS", "Stripe", "AWS S3"],
  keyFeatures: [
    { title: "Cultural Vendor Discovery", description: "Find vendors by culture—Nigerian DJs, Ghanaian caterers, Indian photographers—through a structured cultural taxonomy." },
    { title: "Diaspora-Focused Marketplace", description: "Purpose-built for diaspora communities planning culturally authentic celebrations abroad." },
    { title: "Trusted Vendor Directory", description: "Curated, community-verified vendors who understand and respect cultural traditions." },
    { title: "End-to-End Planning Tools", description: "Inquiry management, cultural ceremony templates, and booking workflows for multi-day celebrations." },
  ],
  description: "Festura is a culture-first wedding and vendor marketplace that connects couples planning culturally specific celebrations with verified vendors who understand their heritage. From Nigerian-themed weddings to multi-day South Asian ceremonies, Festura treats cultural background as a primary search dimension—not an afterthought.",
  problemStatement: {
  ...
  outcomes: "Creating the go-to marketplace for culturally aligned wedding vendors—making it easy for diaspora couples to celebrate their heritage with authentic, community-trusted professionals.",

...
export const forgecms: ProjectDetail = {
  ...
  slug: "forgecms",
  name: "ForgeCMS",
  subline: "Write Better. Publish Faster. Own Your Content.",
  category: "fullstack",
  status: "in-progress",
  technologies: ["Next.js", "React", "TypeScript", "Tailwind CSS", "OpenAI", "PostgreSQL", "Prisma", "Redis", "Vercel"],
  keyFeatures: [
    { title: "Distraction-Free Editor", description: "Clean writing surface with real-time autosave, version history, and export to Markdown, HTML, and PDF—nothing between you and the draft." },
    { title: "AI Writing Assistant", description: "Grammar, tone analysis, SEO scoring, and headline suggestions inline—AI that polishes your voice instead of replacing it." },
    { title: "Headless / API-First Publishing", description: "One-click publish, scheduled posts, custom domains, and API access so content lives on your blog, app, or anywhere else." },
    { title: "Team Collaboration (Roadmap)", description: "Real-time co-editing, inline comments, and editorial workflows—agency-ready without agency pricing." },
  ],
  description: "ForgeCMS is the CMS writers wish existed: distraction-free editor, AI grammar and tone analysis, SEO scoring, and headless API publishing—all in one stack. No plugin rabbit holes. No 10% platform fees. No Grammarly tab juggling. Freemium from $0 to agency tiers, built on Next.js with streaming AI responses and version history that actually works.",
  problemStatement: {
  ...
  outcomes: "ForgeCMS proves a solo builder can compete with WordPress and Ghost on product quality—unified AI writing tools, headless publishing, and pricing that doesn't punish creators for growing.",
